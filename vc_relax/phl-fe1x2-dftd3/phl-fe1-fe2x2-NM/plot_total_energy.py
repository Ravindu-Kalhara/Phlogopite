...
# File paths
file_paths = ["vc_relax-prev01.out", "vc_relax-prev02.out", "vc_relax-prev03.out", "vc_relax.out"]
...
axs[1].axhline(y=1e-6, color='k', linestyle='--', linewidth=1, label="etot_conv_thr")
